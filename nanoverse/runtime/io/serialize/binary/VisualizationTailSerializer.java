 ...
 */
public class VisualizationTailSerializer extends Serializer {
    ...
    @FactoryTarget
    public VisualizationTailSerializer(GeneralParameters p,
    ...
    public void dispatchHalt(HaltCondition ex) {
        ...
        int dummy = 0;
        renderer.renderAll(highlightChannels, dummy);
