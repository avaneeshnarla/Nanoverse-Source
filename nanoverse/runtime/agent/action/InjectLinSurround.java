 ...
 */
public class InjectLinSurround extends Action {
    ...
    public InjectLinSurround(Agent callback, LayerManager layerManager, String
            layerId,
    ...
    public boolean equals(Object o) {
        ...
        InjectLinSurround inject = (InjectLinSurround) o;
    ...
    public Action copy(Agent child) {
        return new InjectLinSurround(child, mapper.getLayerManager(), layerId,
