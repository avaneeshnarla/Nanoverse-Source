 ...
 */
public class ReactionLinClassSymbolTable extends ClassSymbolTable<ReactionLin> {
    ...
    private void ReactionLin(HashMap<String, Supplier<InstantiableSymbolTable>> ret) {
        Supplier<InstantiableSymbolTable> supplier = ReactionLinInstSymbolTable::new;
        ret.put("ReactionLin", supplier);
    }

    @Override
    public String getDescription() {
        return "Agents can interact with the local value of a continuum. " +
                "ReactionLins specify the terms of those interactions, allowing " +
