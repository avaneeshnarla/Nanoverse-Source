...
import nanoverse.compiler.pipeline.instantiate.loader.layers.continuum.ReactionLinLoader;
 ...
 */
public class ReactionLinInstSymbolTable extends MapSymbolTable<ReactionLin> {

    @Override
    public Loader getLoader() {
        return new ReactionLinLoader();
    }
