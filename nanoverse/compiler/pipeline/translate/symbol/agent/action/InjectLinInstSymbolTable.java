...
import nanoverse.compiler.pipeline.instantiate.loader.agent.action.InjectLinLoader;
 ...
 */
public class InjectLinInstSymbolTable extends ActionInstSymbolTable<InjectLinDescriptor> {
    @Override
