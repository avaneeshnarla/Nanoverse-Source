...
import nanoverse.compiler.pipeline.instantiate.loader.processes.continuum.DegradeProcessLoader;
 ...
 */
public class DegradeProcessInstSymbolTable extends ContinuumProcessInstSymbolTable<DegradeProcess> {

    @Override
    public String getDescription() {
        return "Schedule a fixed-value source (Degrade) at a site or sites " +
    ...
    private void layer(HashMap<String, MemberSymbol> ret) {
        ...
        MemberSymbol ms = new MemberSymbol(rst, "Continuum layer upon which to schedule Degrade process.");
        ret.put("layer", ms);
    }
    ...
    public Loader getLoader() {
        return new DegradeProcessLoader();
    }
}
