...
public class InjectLinFactory implements Factory<InjectLinDescriptor> {

    private final InjectLinFactoryHelper helper;
    ...
    public InjectLinFactory() {
        helper = new InjectLinFactoryHelper();
    }

    public InjectLinFactory(InjectLinFactoryHelper helper) {
        this.helper = helper;
    }
    ...
    @Override
    public InjectLinDescriptor build() {
