...
public class InjectLinFactoryHelper {

    public InjectLinDescriptor build(LayerManager layerManager, String
            layerId, String substrateId, DoubleArgument deltaArg) {
        return new InjectLinDescriptor(layerManager, layerId,
