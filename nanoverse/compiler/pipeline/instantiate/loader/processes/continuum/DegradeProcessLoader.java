...
import nanoverse.compiler.pipeline.instantiate.factory.processes.continuum.DegradeProcessFactory;
 ...
 */
public class DegradeProcessLoader extends ProcessLoader<DegradeProcess> {
    private final DegradeProcessFactory factory;
    private final DegradeProcessInterpolator interpolator;

    public DegradeProcessLoader() {
        factory = new DegradeProcessFactory();
        interpolator = new DegradeProcessInterpolator();
    }

    public DegradeProcessLoader(DegradeProcessFactory factory,
                                  DegradeProcessInterpolator interpolator) {
        this.factory = factory;
        this.interpolator = interpolator;
    }

    @Override
    public DegradeProcess instantiate(MapObjectNode node, LayerManager lm, GeneralParameters p) {
