 ...
 */
public class VisualizationTailSerializerInterpolator {

    private final LoadHelper load;
    private final VisualizationTailSerializerDefaults defaults;

    public VisualizationTailSerializerInterpolator() {
        load = new LoadHelper();
        defaults = new VisualizationTailSerializerDefaults();
    }

    public VisualizationTailSerializerInterpolator(LoadHelper load,
                                                   VisualizationTailSerializerDefaults defaults) {
