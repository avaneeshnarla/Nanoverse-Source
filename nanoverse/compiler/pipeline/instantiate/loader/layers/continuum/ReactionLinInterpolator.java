 ...
 */
public class ReactionLinInterpolator {
    private final LoadHelper load;
    private final ReactionLinDefaults defaults;

    public ReactionLinInterpolator() {
        load = new LoadHelper();
        defaults = new ReactionLinDefaults();
    }

    public ReactionLinInterpolator(LoadHelper load,
                                   ReactionLinDefaults defaults) {
